...
public abstract class PaintableObject {
     ...
     * Get the width of the text String.
     *
     * @param txt   CharSequence to get the width of.
    ...
    public void paintCircle(Canvas canvas, float x, float y, float radius) {
        ...
        canvas.getMatrix(matrix);
        // TODO changed this to display circle instead of ring
...
//		myPaint.setColor(0xffff0000); // color.RED
        // float radius = (float) (0.5 * (x + y) * 0.5);

        RectF oval = new RectF(x / 2 - radius, x / 2 - radius, x / 2 + radius,
                x / 2 + radius);
     ...
     * @param text   CharSequence to paint on the Canvas.
     * @param start  Start of the text.
     * @param end    End of the text.
