...
public class Marker implements Comparable<Marker> {
    ...
    private boolean noAltitude = true;
    ...
    public Marker(String name, double latitude, double longitude,
                  double altitude, int color, ArResults store) {
        // set(name, latitude, longitude, altitude, color, store);
        set(name, latitude, longitude, 0, color, store);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        // TODO: here i removed the text under the icon
        // drawText(canvas);
    ...
    private void drawText(Canvas canvas) {
        ...
        if (distance < 1000.0) {
            textStr.append(name).append(" (")
                    .append(DECIMAL_FORMAT.format(distance)).append("m)");
        } else {
            double d = distance / 1000.0;
            textStr.append(name).append(" (").append(DECIMAL_FORMAT.format(d))
                    .append("km)");
        }
    ...
    public ArResults getStore() {
        return store;
    }

    public void setStore(ArResults store) {
        this.store = store;
    }
